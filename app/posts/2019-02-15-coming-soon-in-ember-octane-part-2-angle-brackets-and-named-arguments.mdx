---
title: 'Coming Soon in Ember Octane: Angle(nbsp)Brackets & Named(nbsp)Arguments'
tagline: ''
archived: true
---
...
- [Angle Brackets & Named Arguments](/blog/coming-soon-in-ember-octane-part-2-angle-brackets-and-named-arguments) _← this post_
