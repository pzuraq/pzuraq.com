...
* [The Native Class Constructor Update RFC](#native-class-constructor-update-rfc)
* [`new` vs. `create`](#new-vs-create)
* [`constructor` vs. `init`](#constructor-vs-init)
* [Class Fields vs. `extend()`](#class-fields-vs-extend)
* [Avoid Class Field Arrow Functions](#avoid-class-field-arrow-functions)
* [`super` vs. `_super()`](#super-vs-_super)
* [When It's Ok to Use `extend()`](#when-its-ok-to-use-extend)
* [Avoiding `reopen` and `reopenClass`](#avoiding-reopen-and-reopenclass)
* [Avoiding `EmberObject`](#avoiding-emberobject)
* [Misc. Class Tips](#misc-class-tips)
